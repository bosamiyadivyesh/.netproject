        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_tasks_priority", "\"Priority\" IN ('low','medium','high','urgent')");
                    table.CheckConstraint("CK_tasks_status", "\"Status\" IN ('pending','in_progress','completed','cancelled')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_task_history_action", "\"Action\" IN ('created','updated','deleted','status_changed','completed')");
                    table.ForeignKey(
